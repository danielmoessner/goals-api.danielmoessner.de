  ...
  <div class="w-full bg-white md:min-h-screen sticky top-0">
    <div
      ...
      <div class="h-8 flex items-center">
        <svg class="max-h-full max-w-full h-full mr-2 md:-ml-4" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 512 512">
      ...
      <ul class="flex flex-col w-full">
        ...
        <div v-for="group in navigation" v-bind:key="group.name">
          ...
          <li class="my-px" v-for="link in group.links" v-bind:key="link.name">
            <navigation-button v-bind:link="link.url" v-bind:text="link.name"
                               v-bind:icon="link.icon"></navigation-button>
          </li>
        </div>
      </ul>
    </div>
...
module.exports = {
  ...
  components: {
    ...
    'navigation-heading': httpVueLoader('/static/vue/navigation-heading.vue')
  },
  props: {
    navigation: {
      required: true,
