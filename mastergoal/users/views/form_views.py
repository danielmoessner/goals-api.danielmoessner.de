...
class CustomUserStarChoicesHeader(LoginRequiredMixin, UserPassesTestMixin, CustomAjaxFormMixin, generic.UpdateView):
    form_class = CustomUserStarHeaderForm
    template_name = 'snippets/header_form.j2'
    model = CustomUser
